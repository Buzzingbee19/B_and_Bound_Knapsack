...
int knapsack::getTotalCost() const
// Return the cost of the selected objects.
{
  return totalCost;
}

int knapsack::getTotalValue() const
...
// Prints out the solution.
{
  ...
  //cout << "Total cost: " << getTotalCost() << endl << endl;

  myfile << "------------------------------------------------" << endl;

  myfile << "Total value: " << getTotalValue() << endl;
  myfile << "Total cost: " << getTotalCost() << endl;
  ...
  for (int i = 0; i < getNumObjects(); i++) {
    ...
    if (isSelected(i)) {
      ...
      //cout << index[i] << "  " << getValue(i) << " " << getTotalCost(i) << endl;
